...
SC.missions.H2 = (function () {
    // source begin
    var self = SC.commonMission(),
        player,
        st = 'C3';

    self.filename = 'hard_refuel_c3.js';
    self.category = 'Transfer missions';
    self.title = 'Callisto/C1 to C3';
    self.summary = 'Fly to C3 station and refuel there. Distance 4600km, deltaV 1km/s.';
