...
SC.missions.H5 = (function () {
    // source begin
    var self = SC.commonMission(),
        player,
        st = 'I1';

    self.filename = 'hard_refuel_i1.js';
    self.category = 'Transfer missions';
    self.title = 'Callisto/C1 to Io/I1';
    self.summary = 'Fly to Io\'s I1 station and refuel there. Distance 1\'927\'901km, deltaV 19km/s.';
