...
SC.missions.H1 = (function () {
    // source begin
    var self = SC.commonMission(),
        player,
        st = 'C2';

    self.filename = 'hard_refuel_c2.js';
    self.category = 'Transfer missions';
    self.title = 'Callisto/C1 to C2';
    self.summary = 'Fly to C2 station and refuel there. Distance 10000km, deltaV 2km/s.';
